...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row == 0) {
        ...
        AATableViewCell* cell = [tableView dequeueReusableCellWithIdentifier:@"stats" forIndexPath:indexPath];
        cell.title.text = @"Рейтинг\nпроизводителя";
        cell.value.text = @"87.4 / 100";
        
        return cell;
    }else if (indexPath.row == 5) {
        AATableViewCell* cell = [tableView dequeueReusableCellWithIdentifier:@"stats" forIndexPath:indexPath];
        cell.title.text = @"Рейтинг\nлекарства";
        cell.value.text = @"9.2 / 10";
        
        return cell;
    }else if (indexPath.row == 6) {
        AATableViewCell* cell = [tableView dequeueReusableCellWithIdentifier:@"stats" forIndexPath:indexPath];
        cell.title.text = @"Основные причины отзыва";
        cell.value.text = @"";
